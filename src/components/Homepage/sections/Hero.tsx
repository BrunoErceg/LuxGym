...
function Hero() {
  ...
  return (
    <section className="text-light flex h-screen w-auto flex-col justify-between space-y-10 overflow-hidden bg-[url('assets/images/teretana-privatni-trening.jpg')] bg-cover bg-center">
      <Navigation />
