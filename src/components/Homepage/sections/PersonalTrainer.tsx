import PrivatniTrenerSlika from "../../../assets/images/privatni-trener.jpg";
      ...
      <Container>
        <Columns sm={1} md={1} lg={2} gap="lg">
          <Flex direction="col" justify="center" className="justify-center">
            <h5>Luka Škubonja</h5>
            <h2 className="translate-x-[-2px]">{t("personalTrainer.title")}</h2>
            <Accordion
          ...
          <Animated>
            <Flex justify="end" className="relative lg:ml-[15%]">
              ...
              />
              <div className="absolute bottom-[-20px] flex w-[100%] space-x-5 lg:right-10 lg:bottom-10">
                <InfoCard
